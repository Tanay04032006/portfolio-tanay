...
const Page = () => {
  ...
  return (
    <div className="bg-black min-h-screen flex flex-col items-center">
      ...
      <div className="flex gap-[200px] p-10 w-full max-w-7xl">
      <div className="absolute mb-7 inset-0 z-[-1] w-full">
                  <LampDemo/>
                  
                   
                    </div>
        <div className="w-1/3 h-screen flex flex-col justify-center items-center sticky top-0">
        ...
        <div className="w-[65%] space-y-6">
          <ProjectCard
            ...
            techStack={[{ icon: IconBrandReact, color: techColors.IconBrandReact }, { icon: IconBrandTailwind, color: techColors.IconBrandTailwind }, { icon: IconDeviceGamepad2, color: techColors.IconDeviceGamepad2 }]}
          />
          <ProjectCard
            title="HackMatch"
            ...
            live="/projects"
            techStack={[{ icon: IconBrandNextjs, color: techColors.IconBrandNextjs }, { icon: IconBrandFirebase, color: techColors.IconBrandFirebase }, { icon: IconBrandMongodb, color: techColors.IconBrandMongodb }]}
          />
          <ProjectCard
            ...
            techStack={[{ icon: IconBrandReact, color: techColors.IconBrandReact }, { icon: IconBrandTailwind, color: techColors.IconBrandTailwind }, { icon: IconBrandVite, color: techColors.IconBrandVite }]}
          />
          <ProjectCard
            ...
            live="/projects"
            techStack={[{ icon: IconFileText, color: techColors.IconFileText }, { icon: IconBrandReact, color: techColors.IconBrandReact }, { icon: IconBrandTailwind, color: techColors.IconBrandTailwind }]}
          />
          <ProjectCard
            title="Todo App"
            ...
            techStack={[{ icon: IconBrandReact, color: techColors.IconBrandReact }, { icon: IconBrandTailwind, color: techColors.IconBrandTailwind }, { icon: IconBrandFirebase, color: techColors.IconBrandFirebase }]}
          />
          <ProjectCard
            title="Expenze"
            ...
            live="/projects"
            techStack={[{ icon: IconBrandNextjs, color: techColors.IconBrandNextjs }, { icon: IconBrandMongodb, color: techColors.IconBrandMongodb }, { icon: IconBrandTailwind, color: techColors.IconBrandTailwind }]}
          />
          <ProjectCard
            title="Jarvis AI"
